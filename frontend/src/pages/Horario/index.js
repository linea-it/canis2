    ...
    <Container>
      ...
      >
        ...
        <Grid item xs={12} sm={6} md={5} style={{ width: '100%' }}>
          ...
          >
            Minicurso LIneA Science Server - Adriano Pieres
          </Typography>
        </Grid>
        ...
        <Grid item xs={12} sm={6} md={5} style={{ width: '100%' }}>
          <Typography
            ...
            style={{ fontSize: '1.4rem' }}
          >
            Minicurso Jupyter Notebook - Julia Gschwend
          </Typography>
        </Grid>
        ...
        <Grid item xs={12} sm={6} md={5} style={{ width: '100%' }}>
          <Typography variant="subtitle1" color="primary">
            <strong>Aula 2</strong>: Python básico (cont.) e operações com
            arrays usando Numpy
          </Typography>
          <Typography variant="h6" color="primary">
        ...
        <Grid item xs={12} sm={6} md={5} style={{ width: '100%' }}>
          <Typography variant="subtitle1" color="primary">
            <strong>Aula 3</strong>: SQL básico, Pandas Series & DataFrame
          </Typography>
          <Typography variant="h6" color="primary">
